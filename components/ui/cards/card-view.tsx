                    ...
                    <div className="flex items-center gap-3">
                        {type === "remembered" ? (
                            ...
                            <>
                                ...
                                <div>
                                    <p className="font-semibold text-orange-700">Marked for review</p>
...
export function CardView() {
    ...
    const [feedback, setFeedback] = useState<"remembered" | "review" | null>(null)
                    ...
                    <Card className="p-8 max-w-md mx-auto bg-white border-2 border-slate-200">
                        ...
                        <div className="space-y-2 mb-6">
                            <p className="text-lg text-slate-700">
                                Final Score: <span className="font-semibold text-green-600">{score} XP</span>
                            </p>
                            <p className="text-slate-600">
                                Cards for Review: <span className="font-semibold text-orange-600">{reviewCount}</span>
                            </p>
                            <p className="text-slate-600">
                                Cards Remembered:{" "}
                                <span className="font-semibold text-green-600">{flashcardData.length - reviewCount}</span>
                            </p>
                        </div>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-md mb-8">
              ...
              {currentCardIndex + 1} / {flashcardData.length}
                    ...
                    <motion.div className="h-2 bg-slate-200 rounded-full overflow-hidden" initial={false}>
                        <motion.div
            ...
            <div className="w-full max-w-md mt-8">
                <div className="flex justify-center gap-8 text-center">
                    <div>
                        <p className="text-2xl font-bold text-green-600">{Math.floor(score / 20)}</p>
